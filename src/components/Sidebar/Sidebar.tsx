...
export default function Sidebar() {
  ...
  const { theme, layout, displayMobileMenu } = useSelector(
    ...
    <>
      <Box
        sx={{
          ...
          zIndex: 15,
          opacity: isMobile && displayMobileMenu ? 1 : 0,
          pointerEvents: isMobile && displayMobileMenu ? "all" : "none",
        }}
        onClick={() => {
      ...
      <Box
        position="fixed"
        top="0px"
        left={isMobile ? (displayMobileMenu ? "0px" : "-260px") : "0px"}
        height="100vh"
        zIndex={20}
        width={fullDisplay ? "260px" : "85px"}
        sx={{
          backgroundColor: isMobile
            ? "filterBackgroundColor.secondary"
            : "background.default",
          borderRightColor: isMobile ? "none" : "border.primary",
          borderRightStyle: isMobile ? "none" : "dashed",
          borderRightWidth: isMobile ? "0px" : "1px",
          backdropFilter: "blur(20px)",
          boxShadow: isMobile && displayMobileMenu ? boxShadow : "none",
