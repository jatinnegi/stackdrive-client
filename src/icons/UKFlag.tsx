export function UKFlag() {
  return (
    ...
    >
      <defs>
        <path id="iconifyReact3139" fill="#fff" d="M0 0h32v24H0z"></path>
      </defs>
      <g fill="none">
        <g clipPath="url(#iconifyReact3142)">
          <use href="#iconifyReact3139"></use>
          <path
            fill="#2E42A5"
            fillRule="evenodd"
            d="M0 0v24h32V0H0Z"
          ...
          <g mask="url(#iconifyReact3140)">
            <path
              fill="#fff"
              d="m-3.563 22.285l7.041 2.979L32.16 3.238l3.714-4.426l-7.53-.995l-11.698 9.491l-9.416 6.396l-10.793 8.581Z"
            ></path>
            <path
              fill="#F50100"
            ...
            ></path>
            <mask id="iconifyReact3141" fill="#fff">
              <path
                fillRule="evenodd"
            ...
            <path
              ...
              mask="url(#iconifyReact3141)"
            ></path>
          </g>
        </g>
        <defs>
          <clipPath id="iconifyReact3142">
            <use href="#iconifyReact3139"></use>
          </clipPath>
        </defs>
      </g>
